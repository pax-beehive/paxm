...
func (r runner) printHelp() {
	...
	_, _ = fmt.Fprintln(r.stdout, "  paxm [--config PATH] backfill scan --agent AGENT [--after TIME] [--before TIME]")
	_, _ = fmt.Fprintln(r.stdout, "  paxm [--config PATH] backfill run --agent AGENT --provider NAME [--after TIME] [--before TIME] [--background]")
